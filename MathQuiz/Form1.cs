...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        // Create an audio object for a correct guess
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                // Display the new time left and
                // turn the timeLabel background red.
                timeLeft--;
                timeLabel.Text = timeLeft + " seconds";
        ...
        private void sum_Changed(object sender, EventArgs e)
        {
            if (sum.Value == addend1 + addend2)
            {
                ...
                sum.BackColor = Color.LightSalmon;
            else
                sum.BackColor = Color.Empty;
        }

        private void diff_Changed(object sender, EventArgs e)
        {
            if (difference.Value == minuend - subtrahend)
            {
                ...
                difference.BackColor = Color.LightSalmon;
            else
                difference.BackColor = Color.Empty;
        }

        private void prod_Changed(object sender, EventArgs e)
        {
            if (product.Value == multiplicand * multiplier)
            {
                ...
                product.BackColor = Color.LightSalmon;
            else
                product.BackColor = Color.Empty;
        }

        private void quot_Changed(object sender, EventArgs e)
        {
            if (quotient.Value == dividend / divisor)
            {
                ...
                quotient.BackColor = Color.LightSalmon;
            else
                quotient.BackColor = Color.Empty;
        }
    }
}
